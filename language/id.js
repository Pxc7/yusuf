...
exports.addwarn = `Peringatan\nKamu mendapatkan 1 peringatan`;
exports.delwarn = `Peringatan\nWarning kamu telah berkurang 1 peringatan`;
exports.cekwarn = (warn) => {
  return `User memiliki peringatan sebanyak ${warn}`;
};
...
exports.promote = (value) => {
  return `Sukses menaikkan jabatan member ${value} menjadi admin`;
};
...
exports.timeout = 'Waktu sudah habis jawabannya adalah ';
exports.salah = '*Salah!*\nCoba lagi';
...
exports.inAfk = (value, time) => {
  return 'User sedang dalan mode Afk\nJangan Di Ganggu!\n\nAlasan:' + value + '\n Pada : ' + time
}