...
const { jadibot, stopjadibot, listjadibot } = require('./result/buatbot/jadibot')
const { 
  createExif,
  modStick,
  h2k, 
...
`
  ...
  case 'author':
    ...
    capt += 'Instagram : https://www.instagram.com/riugnz_'
    await client.fakeLink(from, capt, thumb, 'Click in here', 'https://www.instagram.com/riugnz_', mek)
...
jadibot(m.reply,client,from, mek)
break
...
case 'attp':
              ...
              .catch((err) => {
                            ...
                            m.reply('Jangan Menggunakan Emoji!!')
                        })
              break
